...
{
    // warm-start
    // for (int i=0; i<NX*(NH); i++){
	// 	acadoVariables.x[i] = warm_start_state[i+NX];
	// }
	// for (int i=0; i<NX; i++){
	// 	acadoVariables.x[NX*NH+i] = warm_start_state[NX*(NH-1)+i];
	// 	// acadoVariables.x[NX*NH+i] = reference_state(i);
	// }

	// for (int i=0; i<NU*(NH-1); i++){
	// 	acadoVariables.u[i] = warm_start_control[i+NU];
	// }
	// for (int i=0; i<NU; i++){
	// 	acadoVariables.u[NU*(NH-1)+i] = warm_start_control[NU*(NH-1)+i];
	// 	// acadoVariables.u[NU*(NH-1)+i] = reference_control(i);
	// }
