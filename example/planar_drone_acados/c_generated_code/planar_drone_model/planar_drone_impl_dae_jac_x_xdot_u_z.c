...
/* planar_drone_impl_dae_jac_x_xdot_u_z:(i0[6],i1[6],i2[2],i3[],i4[],i5[])->(o0[6x6,5nz],o1[6x6,6nz],o2[6x2,6nz],o3[6x0]) */
...
CASADI_SYMBOL_EXPORT casadi_int planar_drone_impl_dae_jac_x_xdot_u_z_n_in(void) { return 6;}
